...
the [unicode table](https://symbl.cc/en/unicode/table/), for example the rune 
for the lower case "h" is [U+0068](https://symbl.cc/en/unicode/table/#0068). 
...
for example the 7 bits "1101000" follow the initial "0" in the encoding of "h". 🌍 correspond to the rune [U+1F30D](https://symbl.cc/en/unicode/table/#1F30D), i.e. the rune number `0x1F30D`. 
